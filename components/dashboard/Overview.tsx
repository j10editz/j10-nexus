...
const quickActions = [
  {
    title: "Agent",
    description: "Create an AI revenue or operations agent",
    icon: Bot,
  ...
  {
    title: "Flow",
    description: "Build a customer operation flow",
    icon: Workflow,
  ...
  {
    title: "Revenue",
    description: "Review pipeline and payment activity",
    icon: TrendingUp,
...
export default function Overview({
  ...
  return (
    <div className="j10-canvas min-h-full text-white">
      <div className="mx-auto max-w-[1500px] px-6 py-8 lg:px-8">
        {/* HEADER */}
        <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end">
          <div>
            <p className="mb-3 text-sm font-medium text-cyan-300">J10 AI command center</p>
            <h1 className="max-w-2xl text-3xl font-semibold tracking-[-0.045em] sm:text-4xl">
              Good afternoon. Here&apos;s what J10 is handling.
            </h1>
            <p className="mt-3 text-sm leading-6 text-[#8d96a8]">
              Your customer conversations, revenue movement, and team follow-ups in one operating view.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            {createOpen && (
              <div className="absolute right-0 top-[calc(100%+8px)] z-20 w-64 rounded-2xl border border-white/[0.09] bg-[#101115] p-2 shadow-2xl shadow-black/50">
                {[
                  {
                    label: "Deploy J10 Agent",
                    href: "/dashboard/ai-employees",
                    icon: Bot,
                  },
                  {
                    label: "Build Revenue Flow",
                    href: "/dashboard/automation/flow",
                    icon: Workflow,
                  },
                  {
        ...
        <div className="mb-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {stats.map((stat) => {
            ...
            return <div key={stat.label} className="j10-surface j10-interactive relative overflow-hidden rounded-2xl p-5"><div className="absolute -right-8 -top-8 h-24 w-24 rounded-full bg-blue-500/10 blur-3xl"/><div className="relative flex items-start justify-between"><div><p className="text-sm text-[#9ea8bb]">{stat.label}</p><p className="mt-2 text-3xl font-semibold tracking-[-.04em] text-white">{stat.value}</p><p className="mt-2 text-xs text-[#8d96a8]">{stat.description}</p></div><span className="flex h-9 w-9 items-center justify-center rounded-xl border border-blue-400/20 bg-blue-500/[.09] text-cyan-300"><Icon size={17}/></span></div><span className="relative mt-4 inline-flex rounded-md bg-emerald-400/[.1] px-2 py-1 text-[10px] font-medium text-emerald-300">{stat.change}</span></div>;
          })}
        </div>
        ...
        {/* WORKFORCE OPERATIONAL HEALTH */}
        <div className="mt-6 mb-2">
          <h2 className="text-sm font-bold uppercase tracking-wider text-[#8d96a8]">
            AI Workforce Status
          </h2>
        </div>
