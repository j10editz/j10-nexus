...
interface PublicFunnelViewProps {
  funnel: WebsiteFunnel;
  slug: string;
}

export function PublicFunnelView({ funnel, slug }: PublicFunnelViewProps) {
  ...
  const whatsappHref =
    f.primaryCtaLink ||
    buildWhatsAppClickToChatLink(null, `Hello! I would like to learn more about ${f.title}.`);
